...
for i in range(len(band)):
    toa_input_1 = readToa('/home/luss/my_shared_folder/EODP_TER_2021/EODP-TS-L1B/output', 'l1b_toa_' + band[i] + '.nc')
    toa_test_1 = readToa('/home/luss/my_shared_folder/test_l1b', 'l1b_toa_' + band[i] + '.nc')
...
# Read the toa's from the import - turn this into a loop
for i in range(len(band)):
    toa_isrf = readToa('/home/luss/my_shared_folder/EODP_TER_2021/EODP-TS-L1B/input', 'ism_toa_isrf_' + band[i] + '.nc')
    #toa_restored = readToa('/home/luss/my_shared_folder/EODP_TER_2021/EODP-TS-L1B/output', 'l1b_toa_' + band[i] + '.nc')
    toa_restored = readToa('/home/luss/my_shared_folder/test_l1b', 'l1b_toa_' + band[i] + '.nc')
